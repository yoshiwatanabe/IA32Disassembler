// PECodeSection.cpp: implementation of the PECodeSection class.
//
//////////////////////////////////////////////////////////////////////
...
#include "PECodeSection.h"

const char PECodeSection::PARSER_SERVER_FILENAME[]	= { "IA32Parser.dll" };
const char PECodeSection::PARSER_CREATION_ROUTINE[] = { "CreateInstructionParser" };
const char*	PECodeSection::m_strErrorMessages[]		= {

	"PECodeSection object exception: Can't load code section parser server IA32Parser.dll. Make sure the server is in the PATH.",
	"PECodeSection object exception: Can't find parser creation routine CreateInstructionParser() in the server",
	"PECodeSection object exception: Can't instantiate InstructionParser object using CreateInstructionParser() routine in the server"
};

std::string PECodeSection::m_error;

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

PECodeSection::PECodeSection(DWORD begin, UINT size)
...
// 
void PECodeSection::initializeParser()
{
	// ===========================================================
	...
	// [1]
	{
		m_parser_handle = LoadLibrary( PECodeSection::PARSER_SERVER_FILENAME );
	...
	FARPROC function_pointer = 
		GetProcAddress( m_parser_handle, PECodeSection::PARSER_CREATION_ROUTINE );
...
//
void PECodeSection::DoCosoleOutput()
{
...
void PECodeSection::GetLastError(std::string& buf)
{
	buf = m_error;
}